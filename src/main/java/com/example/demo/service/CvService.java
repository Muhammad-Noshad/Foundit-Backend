...
public interface CvService {
    ...
    void updateEmail(Integer cvId, String email);
    void updatePhone (Integer cvId, String phone);

    UserCV createNewCv(Integer userId, String name, String address,String phone, String email, String summary);
    ...
    void addSkill(Integer cvID,List<CvSkills> skills);
    boolean removeSkillsByID(Integer skillID);
}
